export function UserWhiteIcon(props) {
    return (
...
export function UserSolidIcon(props) {
    return (
        <svg className="w-6 h-6 text-gray-800 dark:text-white" ariaHidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
